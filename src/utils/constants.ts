...
export const CONTRACT_BALANCE_CONSTANTS = {
  MIN_SALARY: 400,
  MAX_SALARY: 100000,
  DEFAULT_TEAM_LOYALTY: 60,
  MIN_TEAM_LOYALTY: 0,
  MAX_TEAM_LOYALTY: 100,
  RENEWAL_MAX_INCREASE_RATE: 1.2,
  RENEWAL_MAX_DECREASE_RATE: 0.85,
  HIGH_SALARY_THRESHOLD: 2000,
  NORMAL_SALARY_ROUNDING_UNIT: 10,
  HIGH_SALARY_ROUNDING_UNIT: 100,
} as const;
